...
int main(int argc, char* argv[]) {
    ...
    threads = stoi(argv[1], nullptr, 10);
    rows = stoi(argv[2], nullptr, 10);
    cols = stoi(argv[3], nullptr, 10);
    iters = stoi(argv[4], nullptr, 10);
    td = stod(argv[5], nullptr);
    h = stod(argv[6], nullptr);
...
void usage() {
    ...
    cout << "Arguments: threads m n np td h" << endl << flush;
}
